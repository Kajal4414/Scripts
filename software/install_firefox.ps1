...
function ConfigureFiles($installDir) {
    ...
    $files = @(
        @{Name = "policies.json"; Url = "https://raw.githubusercontent.com/Kajal4414/Scripts/main/firefox/policies.json"; Path = "$installDir\distribution\policies.json" },
        @{Name = "autoconfig.js"; Url = "https://raw.githubusercontent.com/Kajal4414/Scripts/main/firefox/autoconfig.js"; Path = "$installDir\defaults\pref\autoconfig.js" },
        @{Name = "firefox.cfg"; Url = "https://raw.githubusercontent.com/Kajal4414/Scripts/main/firefox/firefox.cfg"; Path = "$installDir\firefox.cfg" }
    )
...
function main {
    ...
    if ($theme) {
        ...
        $profilePath = (Get-Item "$env:APPDATA\Mozilla\Firefox\Profiles\*.default-release" -ErrorAction SilentlyContinue).FullName
